import { extractHeadings, splitDocumentIntoSections, processDocument, getRecordSize, splitAndAddLargeRecord } from '../src/core/document-processor';
...
describe('Document Processor', () => {
  ...
  describe('splitDocumentIntoSections', () => {
    ...
    it('should handle document without headings', () => {
      ...
      expect(sections[0]).toEqual({"anchor": "", "content": "Just some content Without headings ", "heading": ""});
    });
  });
